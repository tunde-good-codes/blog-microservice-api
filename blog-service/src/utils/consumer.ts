...
// import { sql } from "./db.js"; // Not needed if we only invalidate, not rebuild

interface CacheInvalidationMessage {
  action: string;
  keys: string[]; // Expected to be Redis key patterns (e.g., "blog:123", "blogs:*")
}
...
export const startCacheConsumer = async () => {
  try {
    ...
    console.log(
      "✅ Blog Service cache consumer started. Waiting for messages..."
    );
